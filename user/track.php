		...
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
				...
				<div class="input-group col-sm-5">
                    <h1><input type="search" id="ref_no" class="form-control form-control-sm" placeholder="" style="font-size: 20px; height: 45px;"></h1>
                    <div class="input-group-append">
                       &nbsp;&nbsp;&nbsp; <button type="button" id="track-btn" class="btn-1">
                            Tracking
                        </button>
                    </div>
                </div>
